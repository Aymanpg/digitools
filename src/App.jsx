        ...
        <div className="text-center mb-8">
          ...
          <div className="flex justify-center gap-2">
            <button
              ...
              className={`px-6 py-2 rounded-full font-semibold transition ${activeTab === "products" ? "bg-blue-700 text-white" : "bg-gray-100 text-gray-700"}`}
            >
              Products
            </button>
            <button
              onClick={() => setActiveTab("cart")}
              className={`px-6 py-2 rounded-full font-semibold transition ${activeTab === "cart" ? "bg-blue-700 text-white" : "bg-gray-100 text-gray-700"}`}
            >
